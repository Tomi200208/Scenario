...
time for startup and cleanup. Abrupt runner loss/cancellation and concurrent
callback idempotency still need separate recovery work; do not claim reliable
long-running or interactive sessions from this batch hosting design.
